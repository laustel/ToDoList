...
const List = (props: { todos: any; actions: any; visibleTodos: any; leftOnPress: any; leftUnactiveIcon: any; leftActiveIcon: any; rightOnPress: any; rightUnactiveIcon: any; rightActiveIcon: any; iconDelete: any; onDelete: any; textOnPress: any; }) => {
  const {
    todos,
    actions,
    visibleTodos,
  ...
  const _renderList = (todo: { isDone: any; isStarred: any; id: any; text: any; }, index: any) => {
